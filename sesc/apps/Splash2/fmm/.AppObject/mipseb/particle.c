...
CreateDistribution (cluster_type cluster, model_type model)
{
   ...
   particle_array = (particle *) our_malloc(Total_Particles * sizeof(particle),__FILE__,__LINE__);;

   Particle_List = (particle **) our_malloc(Total_Particles * sizeof(particle *),__FILE__,__LINE__);;
...
CreateParticleList (int my_id, int length)
{
   ...
   Local[my_id].Particles = (particle **) our_malloc(length 
						   * sizeof(particle *),__FILE__,__LINE__);;
...
/* Generated from ../Source/particle.C */
